...
<head>
	...
	<div class="card" id="feedbackForm">
							...
							<input type="text" class="form-control" placeholder="Name..."style="height:60px;width:80%;border:none;outline:none;background-color:#D3D3D3;padding:10px;margin-top:10px;">
							<input type="email" class="form-control" placeholder="Email..."style="height:40px;width:80%;border:none;outline:none;background-color:#D3D3D3;padding:10px;margin-top:10px;">
							<input type="text" class="form-control" placeholder="Subject..."style="height:40px;width:80%;border:none;outline:none;background-color:#D3D3D3;padding:10px;margin-top:10px;">
							<textarea name=""id="" class="form-control" placeholder="Message..."style="height:100px;width:80%;border:none;outline:none;background-color:#D3D3D3;padding:10px;margin-top:10px;"></textarea>
